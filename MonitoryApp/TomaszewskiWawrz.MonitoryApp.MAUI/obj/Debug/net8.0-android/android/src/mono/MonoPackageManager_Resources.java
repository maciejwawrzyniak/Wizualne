...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "TomaszewskiWawrz.MonitoryApp.MAUI.dll" comes first in this list. */
		"TomaszewskiWawrz.MonitoryApp.MAUI.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"TomaszewskiWawrzyniak.MonitoryApp.BLC.dll",
		"TomaszewskiWawrzyniak.MonitoryApp.Core.dll",
		"TomaszewskiWawrzyniak.MonitoryApp.DAOSQL1.dll",
		"TomaszewskiWawrzyniak.MonitoryApp.Interfaces.dll",
